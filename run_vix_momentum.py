"""Run VIX + Momentum strategy backtest."""
from __future__ import annotations

import logging

from src.strategies.vix_momentum import (
    fetch_data,
    generate_signals,
    run_backtest,
    calculate_metrics,
...
def main():
    ...
    # Generate signals
    signals = generate_signals(nifty_df, vix_df)
    ...
    print("\n" + "="*60)
    print("VIX + Momentum Strategy — Backtest Results")
    print("="*60)
